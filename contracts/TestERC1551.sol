 ...
 */
contract GameItem is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    constructor(string memory uri) ERC1155(uri) {
        ...
        _mint(msg.sender, GOLD, 50, "GOLD");
        _mint(msg.sender, SILVER, 100, "SILVER");
        _mint(msg.sender, THORS_HAMMER, 10, "THORS_HAMMER");
        _mint(msg.sender, SWORD, 500, "SWORD");
        _mint(msg.sender, SHIELD, 20, "SHIELD"); //10**18
    }
