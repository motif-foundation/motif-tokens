...
contract Elysium is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 2000;
    uint256 public price = 169420000000000000000;
    bool public saleOpen = false;
    string public baseURI;

    receive() external payable {}

    constructor() ERC721('Elysium', 'Elysium') {
    	  baseURI = "https://gateway.pinata.cloud/ipfs/QmfXGTpJSdXoBWfxoLeC1Ls7CoHTatbLnsvxibgE5ujKyD/";
        safeMint(msg.sender);
        safeMint(msg.sender);
        safeMint(msg.sender);
        safeMint(msg.sender);
